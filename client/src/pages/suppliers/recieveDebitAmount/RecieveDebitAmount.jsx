import "./recieveDebitAmount.scss";
...
function RecieveDebitAmount() {
  ...
  useEffect(() => {
    ...
    payCreditReturnData.forEach((invoice) => {
  ...
  const handlePaidAmountChange = (invoiceNumber, amount) => {
    ...
    const invoice = payCreditReturnData.find(
      ...
      <div className="content-wrapper">
        ...
        <div className="invoices-section">
            ...
            <div className="table-container">
              <table>
                <thead>
                  <tr>
                    ...
                    <th className="numeric">{t("Debit Amount")}</th>
              ...
              <div className="totals">
                <div className="total-row">
                  <span>{t("Total debit before payment")}</span>
                  <span>
                    {formatNumber(
                ...
                <div className="total-row final">
                  <span>{t("Total debit after payment")}</span>
          ...
          <div className="return-invoices">
            <h2>{t("The invoice covers credit on amount")}</h2>
            <div className="table-container">
              <table>
                <thead>
                  <tr>
...
export default RecieveDebitAmount;
